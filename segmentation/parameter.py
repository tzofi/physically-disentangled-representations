...
def get_parameters():
    ...
    # Testing setting
    parser.add_argument('--test_size', type=int, default=2885) 
    parser.add_argument('--model_name', type=str, default='3780_G.pth') 
    ...
    # Path
    parser.add_argument('--img_path', type=str, default='train_images')
    parser.add_argument('--label_path', type=str, default='train_masks') 
    parser.add_argument('--log_path', type=str, default='./logs')
    parser.add_argument('--model_save_path', type=str, default='./models')
    parser.add_argument('--sample_path', type=str, default='./samples')
    parser.add_argument('--test_image_path', type=str, default='test_images') 
